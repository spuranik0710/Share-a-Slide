	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while(rs1.next()){
				...
				File f = new File("C:/My Data/Share_a_slide/Download/"+uid+"/PPT/ppt_"+i+".ppt");
				if(f.mkdirs()){
				...
				File file_ppt = new File("C:/My Data/Share_a_slide/Download/'"+uid+"'/PPT/images/ppt_"+i+".ppt");
				if(file_ppt.mkdirs()){
				...
				out1 = new FileOutputStream("C:/My Data/Share_a_slide/Download/'"+uid+"'/PPT/images/ppt_image0.png");
				javax.imageio.ImageIO.write(img, "png", out1);
				
				FileInputStream fdd = new FileInputStream(new File("C:/My Data/Share_a_slide/Download/PPT/Images/ppt_image0.png"));
